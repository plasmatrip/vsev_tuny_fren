...
class _PhoneFieldState extends State<PhoneField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<EmployeeRepo>().phone);
    super.initState();
  }
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Номер телефона',
                  style: context.s11w500.copyWith(color: context.watch<EmployeeRepo>().phone.isNotEmpty ? dayTextIconsText_03 : dayBaseBase_02, height: 0),
                ),
              ),
              Padding(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => context.read<EmployeeRepo>().phone = value,
