...
class _SurnameFieldState extends State<SurnameField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<EmployeeRepo>().surname);
    super.initState();
  }
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Фамилия',
                  style: context.s11w500.copyWith(color: context.watch<EmployeeRepo>().surname.isNotEmpty ? dayTextIconsText_03 : dayBaseBase_02, height: 0),
                ),
              ),
              Padding(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => context.read<EmployeeRepo>().surname = value,
