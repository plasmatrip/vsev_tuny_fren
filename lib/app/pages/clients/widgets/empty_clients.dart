    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SvgPicture.asset('assets/vectors/empty_clients.svg', width: 327.w, height: 360.h),
          SizedBox(height: 24.h),
          Text('Нет клиентов', style: context.s15w400.copyWith(color: dayTextIconsText_01)),
          SizedBox(height: 12.h),
          FilledButton(
            onPressed: () async => AutoRouter.of(context).push(const AddClientView()),
