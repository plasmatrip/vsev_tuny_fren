...
class _CommentFieldState extends State<CommentField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<WorkRepo>().comment);
    super.initState();
  }
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Описание',
                  style: context.s11w500.copyWith(color: context.watch<WorkRepo>().comment.isNotEmpty ? dayTextIconsText_03 : dayBaseBase_02, height: 0),
                ),
              ),
              Padding(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => context.read<WorkRepo>().comment = value,
