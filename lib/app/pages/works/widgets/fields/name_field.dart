...
class _NameFieldState extends State<NameField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<WorkRepo>().name);
    super.initState();
  }
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Название',
                  style: context.s11w500.copyWith(color: context.watch<WorkRepo>().name.isNotEmpty ? dayTextIconsText_03 : dayBaseBase_02, height: 0),
                ),
              ),
              Padding(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => context.read<WorkRepo>().name = value,
